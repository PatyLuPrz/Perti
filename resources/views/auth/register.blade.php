                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="rfc" type="text" class="form-control" name="rfc" required autocomplete="rfc">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Confirma tu contraseña</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="notes" type="text" class="form-control" name="notes" required autocomplete="notes"></textarea>
                            </div>
                        </div>
